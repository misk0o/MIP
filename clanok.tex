...
\section{Nová časť} \label{nova}

Toto je nový odsek v novej časti. Môžete tu rozviesť ďalšie informácie alebo diskusiu k téme.

Tu je ďalší odsek, ktorý rozširuje predchádzajúci text a uvádza nové poznatky alebo príklady.
